...
// currency
new Intl.NumberFormat('en-US', { style: 'currency', currency: 'EUR' }).format(1000);
// >> €1,000.00
new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(1000);
// >> 1.000,00 €
new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'USD' }).format(1000);
// >> 1.000,00 $
new Intl.NumberFormat('en-US', { style: 'currency', currency: 'CAD' }).format(12.32);
// >> CA$12.32
new Intl.NumberFormat('en-CA', { style: 'currency', currency: 'CAD' }).format(12.32);
// >> $12.32
...
new Intl.ListFormat('en', { style: 'short', type: 'conjunction' }).format(foods);
// Pizza, Tacos, & Burgers
...
// Pizza, Tacos, Burgers
new Intl.ListFormat('fr-CA', { style: 'long', type: 'conjunction' }).format(foods);
// Pizza, Tacos et Burgers
new Intl.ListFormat('fr-CA', { style: 'long', type: 'disjunction' }).format(foods);
// Pizza, Tacos ou Burgers
new Intl.ListFormat('th-thai', { style: 'long', type: 'disjunction' }).format(foods);
// Pizza, Tacos หรือ Burgers
new Intl.ListFormat('th-thai', { style: 'long', type: 'conjunction' }).format(foods);
